...
fn every_colour_and_section_is_translated_in_every_language() {
    ...
    for (code, _name) in qymcad_i18n::available() {
...
fn the_scheme_editor_buttons_are_translated_in_every_language() {
    ...
    for (code, _) in qymcad_i18n::available() {
        ...
        for (k, t) in [
            ("scheme-created", qymcad_i18n::tr2("scheme-created", "name", "X", "path", "/p")),
            ("scheme-saved", qymcad_i18n::tr1("scheme-saved", "path", "/p")),
            ("scheme-deleted", qymcad_i18n::tr1("scheme-deleted", "name", "X")),
            ("scheme-create-failed", qymcad_i18n::tr1("scheme-create-failed", "error", "e")),
            ("scheme-save-failed", qymcad_i18n::tr1("scheme-save-failed", "error", "e")),
            ("scheme-delete-failed", qymcad_i18n::tr1("scheme-delete-failed", "error", "e")),
            ("scheme-load-failed", qymcad_i18n::tr1("scheme-load-failed", "error", "e")),
        ] {
